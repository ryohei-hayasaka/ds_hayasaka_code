...
def processing_blank_label(processed: ProcessedCurveData | None) -> str:
...
def ir_normalization_label(processed: ProcessedCurveData | None) -> str:
...
def particle_size_normalization_label(
    processed: ParticleSizeProcessedData | None,
) -> str:
...
class TgaAnalyzerApp(tk.Tk):
    ...
    def __init__(self) -> None:
        ...
        self.ir_normalization_selection_key: str | None = None
        self.ir_normalization_preview: float | None = None
        ...
        self.particle_normalization_selection_key: str | None = None
        self.particle_normalization_preview: float | None = None
        ...
        self.events: queue.Queue[tuple[str, object, object | None, BaseException | None]] = queue.Queue()
        ...
        self.tga_active_key: str | None = None
        self.tga_custom_curve_key: str | None = None
        ...
        self.dsc_active_key: str | None = None
        self.dsc_range_selection: DscFourPointSelection | None = None
        self.dsc_selection_snapshot: dict[str, str] = {}
        self._syncing_dsc_range_controls = False
        self.graph_window: GraphWindow | None = None
        self.import_dialog: ImportSettingsDialog | None = None
    ...
    def _set_tga_warning(self, extra: str | None = None) -> None:
    ...
    def _blank_choice_for_key(self, mode: str, key: str | None) -> str:
        if key is None:
            return "(なし)"
    ...
    def _blank_key_from_choice(self, mode: str, value: str) -> str | None:
    ...
    @staticmethod
    def _optional_finite_float(text: str, label: str) -> float | None:
    ...
    def _display_curves(self, mode: str | None = None):
    ...
    def _display_series(self, mode: str | None = None) -> tuple[DisplaySeries, ...]:
    ...
    def _reload_selected_curves(self, tree: ttk.Treeview | None = None) -> None:
    ...
    def _remove_selected_curves(self, tree: ttk.Treeview | None = None) -> None:
        keys = self._selected_loaded_keys(tree)
        if not keys:
            return
        mode = self.mode_var.get()
    ...
    def _set_curve_legend_name(
        self, item: str, legend_name: str, *, parent: tk.Misc | None = None
    ) -> bool:
    ...
    def _selected_loaded_keys(self, tree: ttk.Treeview | None = None) -> list[str]:
    ...
    def _sync_loaded_tree_selection(
        self, keys: list[str], source_tree: ttk.Treeview | None = None
    ) -> None:
        item_ids = [
    ...
    def _on_plot_left_click(self, event) -> str | None:
    ...
    def _on_plot_right_click(self, _event) -> str | None:
    ...
    def _on_escape_pressed(self, _event=None) -> str | None:
        if self.ir_normalization_selection_key is not None:
            self.ir_normalization_selection_key = None
            self.ir_normalization_preview = None
            self._refresh_plot()
    ...
    def _range_from_controls(self, prefix: str, label: str) -> TemperatureRange | None:
    ...
    def _optional_positive_float(self, text: str, label: str) -> float | None:
        stripped = text.strip()
        if not stripped:
            return None
        try:
    ...
    def _current_dsc_key(self) -> str | None:
        if self.mode_var.get() != DSC:
            return None
        keys = self._selected_loaded_keys()
        if keys:
    ...
    @staticmethod
    def _format_result(value: float | None, unavailable: str = "—") -> str:
    ...
    def _export_excel(self, parent: tk.Misc | None = None) -> None:
    ...
    def _handle_event(
        self, event_type: str, context: object, result: object | None, error: BaseException | None
    ) -> None:
...
def _load_curve_batch(
    ...
    profiled_loader: ProfiledCurveLoader | None = None,
    profiles: dict[str, ImportProfile] | None = None,
