...
def ensure_single_window(
    current: WindowT | None, factory: Callable[[], WindowT]
) -> tuple[WindowT, bool]:
...
class GraphWindow(tk.Toplevel):
    def __init__(self, app: TgaAnalyzerApp) -> None:
        ...
        self.color_editor: ColorEditorDialog | None = None
        self.legend_editor: LegendEditorDialog | None = None
        self.inline_legend_editor: ttk.Entry | None = None
        self.inline_legend_item: str | None = None
    ...
    @staticmethod
    def _dialog_alive(dialog: tk.Toplevel | None) -> bool:
        if dialog is None:
            return False
        try:
