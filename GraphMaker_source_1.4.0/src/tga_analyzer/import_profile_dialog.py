...
class ImportSettingsDialog(tk.Toplevel):
    ...
    def __init__(
        ...
        submit,
        apply_callback,
        initial_profile: ImportProfile | None = None,
    ) -> None:
        ...
        self.current_profile: ImportProfile | None = initial_profile
    ...
    def _mapping_from_controls(self, role: str) -> ColumnMapping | None:
