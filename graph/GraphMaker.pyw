"""Double-click source launcher for GraphMaker.

Runs ``src/graphmaker`` with the installed Python interpreter.  No PyInstaller
...
def main() -> None:
    ...
    try:
        from graphmaker.app import main as run_app
